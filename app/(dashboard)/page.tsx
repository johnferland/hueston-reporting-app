...
import { getCumulativeAsOf, getPeriodRange, isPeriodKey, type PeriodKey } from "@/lib/period";
  ...
  return (
    <Page>
      <PageHeader
        ...
        description={`Account totals through ${asOf.current} vs ${asOf.previous}. Open a brand for the full dashboard.`}
