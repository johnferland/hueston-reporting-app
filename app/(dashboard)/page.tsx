...
import { getPeriodRange, getPreviousPeriodRange, isPeriodKey, type PeriodKey } from "@/lib/period";
  ...
  return (
    <Page>
      <PageHeader
        ...
        description={`${range.start} to ${range.end} totals vs ${previous.start} to ${previous.end}. Open a brand for the full dashboard.`}
