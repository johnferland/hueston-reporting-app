...
import { getPeriodRange, getSnapshotAsOf, isPeriodKey, type PeriodKey } from "@/lib/period";
...
export default async function DashboardHome({
  ...
  const asOf = getSnapshotAsOf(period);
  ...
  return (
    <Page>
      <PageHeader
        ...
        description={`Account snapshot ${asOf.current} vs ${asOf.previous}. Open a brand for the full dashboard.`}
